...
namespace QuantConnect.MetatraderBrokerage.ToolBox
{
    static class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                var downloader = new MetatraderBrokerageDownloader();
            }
            else if (targetAppName.Contains("updater") || targetAppName.EndsWith("spu"))
            {
                new ExchangeInfoUpdater(new MetatraderExchangeInfoDownloader())
                    .Run();
            }
            else
            {
